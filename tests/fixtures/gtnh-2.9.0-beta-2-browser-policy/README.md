...
`parity.json` is a compact, immutable format-v5 compatibility excerpt. It pins representative GregTech tool variants
and their real Assembler recipes without
