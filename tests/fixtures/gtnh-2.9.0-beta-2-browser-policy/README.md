...
Ichorium turbine blade, four Ichorium turbine sizes, a second real turbine variant, and every production recipe for
those four turbines. Regenerate it only for a new sibling fixture using
